...
public class SM_LoginPage extends BaseClass {
    WebDriver driver;
	...
	public SM_LoginPage(WebDriver driver)
	{
		this.driver = driver;
		PageFactory.initElements(driver, this);
	}
		
	public void SM_LoginIntoFrontPage() throws InterruptedException
	
	{
		...
		EnterEmail.sendKeys(prop.getProperty("UserEmail03"));
		wait.until(ExpectedConditions.elementToBeClickable(NextButton));
		NextButton.click();
		Thread.sleep(3000);	
		wait.until(ExpectedConditions.elementToBeClickable(EnterPassword));	
		EnterPassword.sendKeys(prop.getProperty("UserPassword03"));

...
public class LoginPage extends BaseClass {
	...
	public void LoginIntoFrontPage() throws InterruptedException
	
	{
		...
		EnterEmail.sendKeys(prop.getProperty("UserEmail"));
		wait.until(ExpectedConditions.elementToBeClickable(NextButton));
		NextButton.click();
		Thread.sleep(3000);	
		wait.until(ExpectedConditions.elementToBeClickable(EnterPassword));	
		EnterPassword.sendKeys(prop.getProperty("UserPassword"));
